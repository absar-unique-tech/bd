...
window.editP = function(id){
  ...
  document.getElementById('editImg').value = (p.images || []).join(', ');
...
window.updateProduct = async function(){
  ...
  try {
    const data = {
      ...
      images: document.getElementById('editImg').value.split(',').map(s=>s.trim()).filter(s=>s),
