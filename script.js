...
async function loadProducts(){
  try {
    ...
    document.getElementById('grid').innerHTML = '<div style="grid-column:1/-1;text-align:center;padding:40px;color:#ff3b30">Firebase Error! Rules চেক করো।</div>';
  }
}
...
function renderProducts(){
  ...
  if(filteredProducts.length === 0){
    grid.innerHTML = '<div style="grid-column:1/-1;text-align:center;padding:40px;color:#999">No products. Add from Admin Panel.</div>';
    return;
  }
